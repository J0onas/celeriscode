...
/src
  ...
  /layouts
    - MainLayout.astro (Header/Footer/SEO)
  /pages
    - index.astro (Home)
    - servicios/index.astro (Catálogo)
    - servicios/[slug].astro (Páginas dinámicas por servicio)
    - portafolio/index.astro (Galería de casos)
    - nosotros.astro (Historia y equipo)
    - contacto.astro (Lead gen)
